...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                校园生活模拟器<br>
                <div style="font-size:1.5rem; font-weight:normal;">北京信息科技大学欢迎你</div>
            </div>
                    ...
                    .forEach(talent=>{
                        ...
                        li.click(()=>{
                            if(li.hasClass('selected')) {
                                ...
                                if(this.#talentSelected.size==3) {
                                    talentPage.find('#next').text('穿越到高考前')
                                }
                            }
                        });
                    });
        ...
        <div id="main">
            ...
            <div class="btn-area">
                ...
                <button id="start" class="mainbtn">开始新的校园生活</button>
            </div>
        </div>
        `);
        ...
        <div id="main">
            ...
            <div class="btn-area">
                ...
                <button id="summary" class="mainbtn">校园生活总结</button>
                <button id="domToImage" class="mainbtn">校园生活回放</button>
            </div>
